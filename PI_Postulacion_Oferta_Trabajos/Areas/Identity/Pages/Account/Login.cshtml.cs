        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        return LocalRedirect("~/Administrador/Index");
                    }
                    else if (await _userManager.IsInRoleAsync(user, "Usuario"))
                    {
                        return LocalRedirect("~/Usuario/Index");
                    }
                    else if (await _userManager.IsInRoleAsync(user, "Empresa"))
                    {
                        return LocalRedirect("~/Empresa/Index");
                    }
