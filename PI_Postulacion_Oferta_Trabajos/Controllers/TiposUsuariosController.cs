...
namespace PI_Postulacion_Oferta_Trabajos.Controllers
{
    public class TiposUsuariosController : Controller
    {
        ...
        public TiposUsuariosController(PO_TrabajosContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.TipoUsuarios != null ? 
                          ...
                          Problem("Entity set 'PO_TrabajosContext.TipoUsuarios'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("TipId,TipNombre,TipDescripcion")] TipoUsuario tipoUsuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TipId,TipNombre,TipDescripcion")] TipoUsuario tipoUsuario)
        {
            if (id != tipoUsuario.TipId)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!TipoUsuarioExists(tipoUsuario.TipId))
                    {
                        return NotFound();
                    }
                    else
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'PO_TrabajosContext.TipoUsuarios'  is null.");
            }
            var tipoUsuario = await _context.TipoUsuarios.FindAsync(id);
            if (tipoUsuario != null)
            {
        ...
        {
          return (_context.TipoUsuarios?.Any(e => e.TipId == id)).GetValueOrDefault();
        }
    }
}
